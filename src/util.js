class Util
{
    static distance()
    {
        if (arguments.length == 4)
            ...
            return Math.sqrt(Math.pow(arguments[0].x - arguments[1].x, 2) + Math.pow(arguments[0].y - arguments[0].y, 2));
    }
    ...
    static doubleDistance()
    {
        if (arguments.length == 4)
            ...
            return Math.pow(arguments[0].x - arguments[1].x, 2) + Math.pow(arguments[0].y - arguments[0].y, 2);
    }
}